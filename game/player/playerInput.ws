...
class CPlayerInput 
{
	...
	{
		var GeraltIsSmartInstance : GeraltIsSmart;
		GeraltIsSmartInstance = new GeraltIsSmart in this;
		GeraltIsSmartInstance.Initialize();
		GeraltIsSmartInstance.addRecipesAndBestiary();
		delete GeraltIsSmartInstance;
